...
@main.route('/credits/<rma_number>/upload', methods=['POST'])
...
@main.route('/api/credits/<rma_number>/images')
...
# ── Per-Branch Kiosk Routes ──────────────────────────────────────────────────
# These serve standalone kiosk pages (no sidebar) at /kiosk/<branch>/...
# Branch identity comes from the URL path; the physical kiosk bookmark
# determines which branch it shows. Old non-branched routes are preserved.
...
@main.route('/kiosk/<branch>/confirm/<int:picker_id>', methods=['GET', 'POST'])
...
@main.route('/kiosk/<branch>/pick/<int:picker_id>/<int:pick_type_id>', methods=['GET', 'POST'])
...
@main.route('/kiosk/<branch>/complete/<int:pick_id>', methods=['POST'])
...
@main.route('/kiosk/<branch>/work-orders/open/<int:user_id>')
...
@main.route('/kiosk/<branch>/work-orders/scan/<int:user_id>')
...
@main.route('/kiosk/<branch>/work-orders/select')
...
@main.route('/kiosk/<branch>/work-orders/complete/<int:wo_id>', methods=['POST'])
...
# ── Per-Branch TV Routes ─────────────────────────────────────────────────────
# Standalone dark-theme passive display pages for warehouse TVs.
...
@main.route('/tv/<branch>/board/<handling_code>')
